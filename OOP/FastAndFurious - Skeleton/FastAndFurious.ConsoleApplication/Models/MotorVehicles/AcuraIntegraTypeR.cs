...
namespace FastAndFurious.ConsoleApplication.Models.MotorVehicles
{
    public class AcuraIntegraTypeR : MotorVehicle
    {
        ...
        public AcuraIntegraTypeR() : base(AcuraIntegraTypeRPriceInUSADollars, AcuraIntegraTypeRWeightInGrams, AcuraIntegraTypeRTopSpeed, AcuraIntegraTypeRAcceleration)
        {
        }
    }
}
