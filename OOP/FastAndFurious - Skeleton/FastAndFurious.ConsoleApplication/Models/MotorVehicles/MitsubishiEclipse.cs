...
namespace FastAndFurious.ConsoleApplication.Models.MotorVehicles
{
    public class MitsubishiEclipse: MotorVehicle
    {
        ...
        public MitsubishiEclipse() : base(MitsubishiEclipsePriceInUSADollars, MitsubishiEclipseWeightInGrams, MitsubishiEclipseTopSpeed, MitsubishiEclipseAcceleration)
        {
        }
    }
}
