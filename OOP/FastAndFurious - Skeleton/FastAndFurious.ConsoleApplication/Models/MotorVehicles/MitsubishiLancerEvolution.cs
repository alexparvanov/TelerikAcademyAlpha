...
namespace FastAndFurious.ConsoleApplication.Models.MotorVehicles
{
     public class MitsubishiLancerEvolution : MotorVehicle
    {
        ...
        public MitsubishiLancerEvolution() : base(MitsubishiLancerEvolutionPriceInUSADollars, MitsubishiLancerEvolutionWeightInGrams, MitsubishiLancerEvolutionTopSpeed, MitsubishiLancerEvolutionAcceleration)
        {
        }
    }
}
