...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Intercoolers
{
    public class ViperGenieIntercooler : Intercooler, IIntercooler, ITunningPart, IAccelerateable, ITopSpeed, IWeightable, IValuable, IIdentifiable
    {
        ...
        public ViperGenieIntercooler() : base(ViperGenieIntercoolerPriceInUSADollars, ViperGenieIntercoolerWeightInGrams, ViperGenieIntercoolerAccelerationBonus, ViperGenieIntercoolerTopSpeedBonus, TunningGradeType.MidGrade, IntercoolerType.ChargeAirIntercooler)
        {
        }
    }
}
