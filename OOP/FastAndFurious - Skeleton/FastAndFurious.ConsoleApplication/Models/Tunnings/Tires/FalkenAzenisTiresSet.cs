...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Tires
{
    public class FalkenAzenisTiresSet : TiresSet, ITunningPart, ITireSet, IAccelerateable, ITopSpeed, IWeightable, IValuable 
    {
        ...
        public FalkenAzenisTiresSet() : base(FalkenAzenisTirePriceInUSADollars, FalkenAzenisTireWeightInGrams, FalkenAzenisTireAccelerationBonus, FalkenAzenisTireTopSpeedBonus, TunningGradeType.LowGrade, TireType.OffRoadTire)
        {
        }
    }
}
