...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Tires
{
    public class MichelinPilotTiresSet : TiresSet, ITunningPart, ITireSet, IAccelerateable, ITopSpeed, IWeightable, IValuable 
    {
        ...
        public MichelinPilotTiresSet() : base(MichelinPilotTirePriceInUSADollars, MichelinPilotTireWeightInGrams, MichelinPilotTireAccelerationBonus, MichelinPilotTireTopSpeedBonus, TunningGradeType.HighGrade, TireType.PerformanceTire)
        {
        }
    }
}
