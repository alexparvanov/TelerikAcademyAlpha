...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Tires
{
    public class YokohamaAdvanTiresSet : TiresSet, ITunningPart, ITireSet, IAccelerateable, ITopSpeed, IWeightable, IValuable 
    {
        ...
        public YokohamaAdvanTiresSet() : base(YokohamaAdvanTirePriceInUSADollars, YokohamaAdvanTireWeightInGrams, YokohamaAdvanTireAccelerationBonus, YokohamaAdvanTireTopSpeedBonus, TunningGradeType.MidGrade, TireType.AllTerrainTire)
        {
        }
    }
}
