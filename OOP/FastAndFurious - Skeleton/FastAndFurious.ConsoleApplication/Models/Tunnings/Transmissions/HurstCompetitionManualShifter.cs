...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Transmissions
{
    public class HurstCompetitionManualShifter : Transmission
    {
        ...
        public HurstCompetitionManualShifter() : base(HurstCompetitionManualShifterPriceInUSADollars, HurstCompetitionManualShifterWeightInGrams, HurstCompetitionManualShifterAccelerationBonus, HurstCompetitionManualShifterTopSpeedBonus, TunningGradeType.MidGrade, TransmissionType.StockShifter)
        {
        }
    }
}
