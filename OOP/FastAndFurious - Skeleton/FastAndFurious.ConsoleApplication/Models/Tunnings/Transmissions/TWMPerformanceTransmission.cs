...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Transmissions
{
    public class TWMPerformanceTransmission : Transmission
    {
        ...
        public TWMPerformanceTransmission() : base(TWMPerformanceTransmissionPriceInUSADollars, TWMPerformanceTransmissionWeightInGrams, TWMPerformanceTransmissionAccelerationBonus, TWMPerformanceTransmissionTopSpeedBonus, TunningGradeType.LowGrade, TransmissionType.SemiManualShifter)
        {
        }
    }
}
