...
namespace FastAndFurious.ConsoleApplication.Models.Tunnings.Turbochargers
{
    public class VortexR35SequentialTurbocharger : Turbocharger, ITurbocharger
    {
        ...
        public VortexR35SequentialTurbocharger() : base(VortexR35SequentialTurbochargerPriceInUSADollars, VortexR35SequentialTurbochargerWeightInGrams, VortexR35SequentialTurbochargerAccelerationBonus, VortexR35SequentialTurbochargerTopSpeedBonus, TunningGradeType.HighGrade, TurbochargerType.SequentialTurbo)
        {
        }
    }
}
