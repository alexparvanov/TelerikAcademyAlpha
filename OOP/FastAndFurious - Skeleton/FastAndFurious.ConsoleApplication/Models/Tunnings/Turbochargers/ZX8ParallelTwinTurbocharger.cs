...
{
    public class ZX8ParallelTwinTurbocharger : Turbocharger, ITurbocharger
    {
        ...
        public ZX8ParallelTwinTurbocharger() : base(ZX8ParallelTwinTurbochargerPriceInUSADollars, ZX8ParallelTwinTurbochargerWeightInGrams, ZX8ParallelTwinTurbochargerAccelerationBonus, ZX8ParallelTwinTurbochargerTopSpeedBonus, TunningGradeType.HighGrade, TurbochargerType.TwinTurbo)
        {
        }
    }
}
